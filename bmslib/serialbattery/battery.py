...
from .utils import logger, safe_number_format, get_pref_config
import logging
import math
...
class History:
    ...
    def __init__(self):
        ...
        self.deepest_discharge: Union[float, None] = None
        """
        ...
        **Should be negative.**
        ...
        self.last_discharge: Union[float, None] = None
        """
        Last discharge in Ampere hours until the battery was charged again.
        **Should be negative.**
        """

        self.average_discharge: Union[float, None] = None
        """
        ...
        **Should be negative.**
        ...
        self.total_ah_drawn: Union[float, None] = None
        """
        ...
        **Should be negative.**
        ...
        self.charge_cycles: Union[int, None] = None
        """
        Number of charge cycles (lifetime).
        Total Amp hours drawn from the battery divided by the capacity.
        """

        self.timestamp_last_full_charge: Union[int, None] = None
        """
        Timestamp of full charge.
        """

        self.full_discharges: Union[int, None] = None
        """
        ...
        self.minimum_voltage: Union[float, None] = None
        """
        Minimum voltage in Volts (lifetime).
        """

        self.maximum_voltage: Union[float, None] = None
        """
        Maximum voltage in Volts (lifetime).
        """

        self.minimum_cell_voltage: Union[float, None] = None
        """
        Minimum cell voltage in Volts (lifetime).
        """

        self.maximum_cell_voltage: Union[float, None] = None
        """
        ...
        self.low_voltage_alarms: Union[int, None] = None
        """
        Number of low voltage alarms (lifetime).
        """

        self.high_voltage_alarms: Union[int, None] = None
        """
        ...
        self.minimum_temperature: Union[float, None] = None
        """
        Minimum temperature in Celsius (lifetime).
        """

        self.maximum_temperature: Union[float, None] = None
        """
        ...
        self.discharged_energy: Union[int, None] = None
        """
        Total discharged energy in Kilowatt-hour (lifetime).
        """

        self.charged_energy: Union[int, None] = None
        """
...
class Cell:
    ...
    balance: Union[bool, None] = None
    """
    The balance status of a specific cell
    """

    def __init__(self, balance: Union[bool, None] = None):
        self.balance = balance


def trigger_soc_reset() -> bool:
    """
...
def turn_balancing_off_callback(path: str, value: int) -> bool:
    return False  # return False to indicate that the callback was not handled
...
class Battery(ABC):
    ...
    def __init__(self, port: str, baud: int, address: str):
        ...
        self.dbus_external_objects: Union[dict, None] = None
        self.online: Union[bool, None] = None
        self.connection_info: str = "Initializing..."
        self.hardware_version: Union[str, None] = None
        self.cell_count: Union[int, None] = None
        self.start_time: int = int(time())
        """
        Timestamp of when the battery was initialized
        """
        # max battery charge/discharge current
        self.max_battery_charge_current: float = PREF_CONFIG.MAX_BATTERY_CHARGE_CURRENT
        self.max_battery_discharge_current: float = PREF_CONFIG.MAX_BATTERY_DISCHARGE_CURRENT
        self.has_settings: bool = False

        # this values should only be initialized once,
        # else the BMS turns off the inverter on disconnect
        self.soc_calc_capacity_remain: Union[float, None] = None
        self.soc_calc_capacity_remain_last_time: Union[float, None] = None
        self.soc_calc_reset_start_time: Union[int, None] = None
        self.soc_calc: Union[float, None] = None  # save soc_calc to preserve on restart
        self.soc: Union[float, None] = None
        self.charge_fet: Union[bool, None] = None
        self.discharge_fet: Union[bool, None] = None
        self.balance_fet: Union[bool, None] = None
        self.block_because_disconnect: bool = False
        self.control_charge_current: Union[int, None] = None
        self.control_discharge_current: Union[int, None] = None
        self.control_allow_charge: Union[bool, None] = None
        self.control_allow_discharge: Union[bool, None] = None

        self.current_avg: Union[float, None] = None
        self.current_avg_lst: list = []
        self.previous_current_avg: Union[float, None] = None
        self.current_external: Union[float, None] = None
        self.capacity_remain: Union[float, None] = None
        self.capacity: Union[float, None] = None
        self.production = None
        self.protection = Protection()
        self.history = History()
        self.version = None
        self.soh: Union[float, None] = None  # state of health
        self.time_to_soc_update: int = 0
        self.temperature_1: Union[float, None] = None
        self.temperature_2: Union[float, None] = None
        self.temperature_3: Union[float, None] = None
        self.temperature_4: Union[float, None] = None
        self.temperature_mos: Union[float, None] = None
        self.cells: List[Cell] = []
        self.control_voltage: Union[float, None] = None
        self.control_voltage_last_limit_time: Union[int, None] = None
        self.soc_reset_requested: bool = False
        self.soc_reset_last_reached: int = 0  # save state to preserve on restart
        self.soc_reset_battery_voltage: Union[int, None] = None
        self.max_battery_voltage: Union[float, None] = None
        self.min_battery_voltage: Union[float, None] = None
        self.allow_max_voltage: bool = True  # save state to preserve on restart
        self.max_voltage_start_time: Union[int, None] = None  # save state to preserve on restart
        self.transition_start_time: Union[int, None] = None
        self.charge_mode: Union[str, None] = None
        self.charge_mode_debug: str = ""
        self.charge_mode_debug_float: str = ""
        self.charge_mode_debug_bulk: str = ""
        self.charge_limitation: Union[str, None] = None
        self.discharge_limitation: Union[str, None] = None
        ...
        self.custom_field: Union[str, None] = None
        """
    ...
    def init_values(self) -> None:
        ...
        self.current: Union[float, None] = None
        self.current_calc: Union[float, None] = None
        self.current_corrected: Union[float, None] = None
        self.power_calc: Union[float, None] = None
    ...
    def unique_identifier(self) -> str:
        ...
        """
        PREF_CONFIG = get_pref_config()
        if PREF_CONFIG.USE_PORT_AS_UNIQUE_ID:
    ...
    def connection_name(self) -> str:
        ...
        """
        return "Serial " + self.port + ("__" + self.address if self.address is not None else "")
    ...
    @abstractmethod
    def get_settings(self) -> bool|DeviceInfoSer:
        """
    ...
    def manage_charge_voltage(self) -> None:
        ...
        if self.cell_count is not None:
            ...
            if self.min_battery_voltage is None:
                self.min_battery_voltage = round(PREF_CONFIG.MIN_CELL_VOLTAGE * self.cell_count, 2)

            # set max battery voltage once
            if self.max_battery_voltage is None:
                self.max_battery_voltage = round(PREF_CONFIG.MAX_CELL_VOLTAGE * self.cell_count, 2)
        else:
        ...
        if PREF_CONFIG.SOC_RESET_AFTER_DAYS is not False:
            self.soc_reset_voltage_management()

        # apply dynamic charging voltage
        if PREF_CONFIG.CVCM_ENABLE:
    ...
    def soc_calculation(self) -> float|None:
        """
        ...
        if self.soc_calc_capacity_remain is not None:
            ...
            PREF_CONFIG = get_pref_config()
            if self.get_min_cell_voltage() <= PREF_CONFIG.MIN_CELL_VOLTAGE:
    ...
    def soc_reset_voltage_management(self) -> None:
        ...
        if (
            PREF_CONFIG.SOC_RESET_AFTER_DAYS is not False
            and self.soc_reset_requested is False
            and self.allow_max_voltage
            and (self.soc_reset_last_reached == 0 or PREF_CONFIG.SOC_RESET_AFTER_DAYS < soc_reset_last_reached_days_ago)
        ):
            self.soc_reset_requested = True

        self.soc_reset_battery_voltage = round(PREF_CONFIG.SOC_RESET_CELL_VOLTAGE * self.cell_count, 2)
    ...
    def manage_charge_voltage_limit(self) -> None:
        ...
        :return: None
        """
        global penalty_sum, clipped_coltage
        time_diff = 0
        ...
        PREF_CONFIG = get_pref_config()
        if PREF_CONFIG.CVL_CONTROLLER_MODE == 1:
            penalty_sum = 0

        if PREF_CONFIG.CVL_CONTROLLER_MODE == 3:
            clipped_coltage = 0
        ...
        try:
            ...
            if self.max_voltage_start_time is None:
                ...
                if (
                    ...
                    and voltage_cell_diff <= PREF_CONFIG.SWITCH_TO_FLOAT_CELL_VOLTAGE_DIFF
                ):
                ...
                # - SoC reset was requested
                    ...
                    PREF_CONFIG.SWITCH_TO_BULK_SOC_THRESHOLD > self.soc_calc
                    or voltage_cell_diff >= PREF_CONFIG.SWITCH_TO_BULK_CELL_VOLTAGE_DIFF
            ...
            # timer started
                ...
                if voltage_cell_diff > (PREF_CONFIG.SWITCH_TO_FLOAT_CELL_VOLTAGE_DIFF + PREF_CONFIG.SWITCH_TO_FLOAT_CELL_VOLTAGE_DEVIATION):
                    self.max_voltage_start_time = current_time

                time_diff = current_time - self.max_voltage_start_time
                # keep max voltage for SWITCH_TO_FLOAT_WAIT_FOR_SEC more seconds
                if PREF_CONFIG.SWITCH_TO_FLOAT_WAIT_FOR_SEC < time_diff:
                    self.allow_max_voltage = False
                    self.max_voltage_start_time = None

                    if self.soc_calc <= PREF_CONFIG.SWITCH_TO_BULK_SOC_THRESHOLD:
                        ...
                        logger.error(
                            ...
                            + f" than SWITCH_TO_BULK_SOC_THRESHOLD ({PREF_CONFIG.SWITCH_TO_BULK_SOC_THRESHOLD}%)."
            ...
            if self.allow_max_voltage:
                ...
                cell_voltage_max_allowed = PREF_CONFIG.SOC_RESET_CELL_VOLTAGE if self.soc_reset_requested else PREF_CONFIG.MAX_CELL_VOLTAGE
                ...
                # use I-Controller
                elif PREF_CONFIG.CVL_CONTROLLER_MODE == 2:
                    if self.control_voltage:
                        control_voltage = self.control_voltage - (
                            (self.get_max_cell_voltage() - cell_voltage_max_allowed - PREF_CONFIG.SWITCH_TO_FLOAT_CELL_VOLTAGE_DIFF) * PREF_CONFIG.CVL_ICONTROLLER_FACTOR
                        )
                    else:
                        control_voltage = self.max_battery_voltage
                ...
                elif PREF_CONFIG.CVL_CONTROLLER_MODE == 3:
                    found_high_cell_voltage = False
                ...
                # if self.get_balancing() and voltage_cell_diff >= PREF_CONFIG.SWITCH_TO_BULK_CELL_VOLTAGE_DIFF:
                if self.get_balancing():
                    self.charge_mode += " + Balancing"

            # Float mode
            else:
                float_voltage = round((PREF_CONFIG.FLOAT_CELL_VOLTAGE * self.cell_count), 2)
                charge_mode = "Float"
                ...
                if self.control_voltage:
                    ...
                    if self.charge_mode is not None and not self.charge_mode.startswith("Float"):
                        ...
                        if PREF_CONFIG.SOC_CALCULATION:
            ...
            # debug information
            if PREF_CONFIG.GUI_PARAMETERS_SHOW_ADDITIONAL_INFO or logger.isEnabledFor(logging.DEBUG):

                soc_reset_days_ago = round((current_time - self.soc_reset_last_reached) / 60 / 60 / 24, 2)
                soc_reset_in_days = round(PREF_CONFIG.SOC_RESET_AFTER_DAYS - soc_reset_days_ago, 2)
                ...
                self.charge_mode_debug = (
                    ...
                    + f"{safe_number_format(PREF_CONFIG.VOLTAGE_DROP, '{:.2f}')} V (VOLTAGE_DROP) = "
                    + f"{safe_number_format((self.control_voltage + PREF_CONFIG.VOLTAGE_DROP), '{:.2f}')} V\n"
                    ...
                    + (f" • penalty_sum: {safe_number_format(penalty_sum, '{:.3f}')} V" if PREF_CONFIG.CVL_CONTROLLER_MODE == 1 else "")
                    + "\n"
                ...
                self.charge_mode_debug_float = (
                    ...
                    + f"{safe_number_format(PREF_CONFIG.SWITCH_TO_FLOAT_CELL_VOLTAGE_DIFF, '{:.3f}')} "
                    + ":SWITCH_TO_FLOAT_CELL_VOLTAGE_DIFF\n"
                    + "AND\n"
                    + f"allow_max_voltage: {self.allow_max_voltage} == True\n"
                    + "AND\n"
                    + f"SWITCH_TO_FLOAT_WAIT_FOR_SEC: {PREF_CONFIG.SWITCH_TO_FLOAT_WAIT_FOR_SEC} < {time_diff} :time_diff"
                )

                self.charge_mode_debug_bulk = (
                    "-- switch to bulk requirements (Linear Mode) --\n"
                    + "a) SWITCH_TO_BULK_SOC_THRESHOLD: "
                    + f"{PREF_CONFIG.SWITCH_TO_BULK_SOC_THRESHOLD} > {self.soc_calc} :soc_calc\n"
                    + "OR\n"
                    + f"b) voltage_cell_diff: {safe_number_format(voltage_cell_diff, '{:.3f}')} >= "
                    + f"{safe_number_format(PREF_CONFIG.SWITCH_TO_BULK_CELL_VOLTAGE_DIFF, '{:.3f}')} "
            ...
            self.control_voltage = round((PREF_CONFIG.FLOAT_CELL_VOLTAGE * self.cell_count), 2)
    ...
    def manage_charge_and_discharge_current(self) -> None:
        ...
        charge_limits = {PREF_CONFIG.MAX_BATTERY_CHARGE_CURRENT: "Max Battery Charge Current"}
        ...
        if isinstance(self.max_battery_charge_current, (int, float)) and PREF_CONFIG.MAX_BATTERY_CHARGE_CURRENT > self.max_battery_charge_current:
            charge_limits.update({self.max_battery_charge_current: "BMS Settings"})

        if PREF_CONFIG.CCCM_CV_ENABLE:
        ...
        if PREF_CONFIG.CCCM_T_MOSFET_ENABLE:
        ...
        if PREF_CONFIG.CCCM_SOC_ENABLE:
        ...
        if (
            int(time()) - self.linear_ccl_last_set >= PREF_CONFIG.CVL_RECALCULATION_EVERY
            or (diff >= self.control_charge_current * PREF_CONFIG.CVL_RECALCULATION_ON_MAX_PERCENTAGE_CHANGE / 100)
            ...
            if ccl == 0:
                ...
                if self.control_charge_current == 0 and ccl < PREF_CONFIG.MAX_BATTERY_CHARGE_CURRENT * PREF_CONFIG.CHARGE_CURRENT_RECOVERY_THRESHOLD_PERCENT:
                    self.charge_limitation = charge_limits[min(charge_limits)] + " *"
                else:
                    self.control_charge_current = ccl
                    self.charge_limitation = charge_limits[min(charge_limits)]
        ...
        discharge_limits = {PREF_CONFIG.MAX_BATTERY_DISCHARGE_CURRENT: "Max Battery Discharge Current"}

        # if BMS limit is lower then config limit and therefore the values are not the same,
        # then the limit was also read from the BMS
        if isinstance(self.max_battery_discharge_current, (int, float)) and PREF_CONFIG.MAX_BATTERY_DISCHARGE_CURRENT > self.max_battery_discharge_current:
            discharge_limits.update({self.max_battery_discharge_current: "BMS Settings"})

        if PREF_CONFIG.DCCM_CV_ENABLE:
        ...
        if PREF_CONFIG.DCCM_T_MOSFET_ENABLE:
        ...
        if PREF_CONFIG.DCCM_SOC_ENABLE:
        ...
        if (
            int(time()) - self.linear_dcl_last_set >= PREF_CONFIG.CVL_RECALCULATION_EVERY
            or (diff >= self.control_discharge_current * PREF_CONFIG.CVL_RECALCULATION_ON_MAX_PERCENTAGE_CHANGE / 100)
            ...
            if dcl == 0:
                ...
                # Don't allow recovery if the new allowed current is smaller than 1% of the previous allowed current
                if self.control_discharge_current == 0 and dcl < PREF_CONFIG.MAX_BATTERY_DISCHARGE_CURRENT * PREF_CONFIG.DISCHARGE_CURRENT_RECOVERY_THRESHOLD_PERCENT:
                    self.discharge_limitation = discharge_limits[min(discharge_limits)] + " *"
                else:
                    self.control_discharge_current = dcl
                    self.discharge_limitation = discharge_limits[min(discharge_limits)]
        ...
        try:
            if PREF_CONFIG.CHARGE_MODE == 2:
                return utils.calc_step_relationship(
                    ...
                    PREF_CONFIG.CELL_VOLTAGES_WHILE_CHARGING,
                    PREF_CONFIG.MAX_CHARGE_CURRENT_CV,
                    False,
                )
            else:
            ...
            logger.error(
                ...
                + f" • CELL_VOLTAGES_WHILE_CHARGING: {PREF_CONFIG.CELL_VOLTAGES_WHILE_CHARGING}"
                + f" • MAX_CHARGE_CURRENT_CV: {PREF_CONFIG.MAX_CHARGE_CURRENT_CV}"
            )
        ...
        try:
            ...
            if PREF_CONFIG.CHARGE_MODE == 2:
                return utils.calc_step_relationship(
                    ...
                    PREF_CONFIG.CELL_VOLTAGES_WHILE_DISCHARGING,
                    PREF_CONFIG.MAX_DISCHARGE_CURRENT_CV,
                    True,
                )
            else:
                return utils.calc_linear_relationship(
            ...
            logger.error(
                ...
                + f" • CELL_VOLTAGES_WHILE_DISCHARGING: {PREF_CONFIG.CELL_VOLTAGES_WHILE_DISCHARGING}"
                + f" • MAX_DISCHARGE_CURRENT_CV: {PREF_CONFIG.MAX_DISCHARGE_CURRENT_CV}"
            )
    ...
    def calc_max_charge_current_from_temperature(self) -> float:
        ...
        try:
                ...
                if PREF_CONFIG.CHARGE_MODE == 2:
                    currents.append(
                        utils.calc_step_relationship(
                            ...
                            PREF_CONFIG.TEMPERATURES_WHILE_CHARGING,
                            PREF_CONFIG.MAX_CHARGE_CURRENT_T,
                            False,
                        )
                    )
                else:
            ...
            logger.error(
                ...
                + f" • TEMPERATURES_WHILE_CHARGING: {PREF_CONFIG.TEMPERATURES_WHILE_CHARGING}"
                + f" • MAX_CHARGE_CURRENT_T: {PREF_CONFIG.MAX_CHARGE_CURRENT_T}"
            )
    ...
    def calc_max_discharge_current_from_temperature(self) -> float:
        ...
        try:
            ...
            for key, currentMaxTemperature in temperatures.items():
                if PREF_CONFIG.CHARGE_MODE == 2:
                    currents.append(
                        utils.calc_step_relationship(
                            currentMaxTemperature,
                            PREF_CONFIG.TEMPERATURES_WHILE_DISCHARGING,
                            PREF_CONFIG.MAX_DISCHARGE_CURRENT_T,
                            True,
                        )
                    )
                else:
            ...
            logger.error(
                f"temperatures: {temperatures}"
                + f" • TEMPERATURES_WHILE_DISCHARGING: {PREF_CONFIG.TEMPERATURES_WHILE_DISCHARGING}"
                + f" • MAX_DISCHARGE_CURRENT_T: {PREF_CONFIG.MAX_DISCHARGE_CURRENT_T}"
            )
        ...
        try:
            ...
            if PREF_CONFIG.CHARGE_MODE == 2:
                return utils.calc_step_relationship(
                    ...
                    PREF_CONFIG.MOSFET_TEMPERATURES_WHILE_CHARGING,
                    PREF_CONFIG.MAX_CHARGE_CURRENT_T_MOSFET,
                    False,
                )
            else:
                return utils.calc_linear_relationship(
            ...
            logger.error(
                ...
                + f" • MOSFET_TEMPERATURES_WHILE_CHARGING: {PREF_CONFIG.MOSFET_TEMPERATURES_WHILE_CHARGING}"
                + f" • MAX_CHARGE_CURRENT_T_MOSFET: {PREF_CONFIG.MAX_CHARGE_CURRENT_T_MOSFET}"
            )
    ...
    def calc_max_discharge_current_from_mosfet_temperature(self) -> float:
        ...
        try:
            ...
            if PREF_CONFIG.CHARGE_MODE == 2:
                return utils.calc_step_relationship(
                    self.temperature_mos,
                    PREF_CONFIG.MOSFET_TEMPERATURES_WHILE_DISCHARGING,
                    PREF_CONFIG.MAX_DISCHARGE_CURRENT_T_MOSFET,
                    False,
                )
            else:
                return utils.calc_linear_relationship(
            ...
            logger.error(
                f"temperature_mos: {self.temperature_mos}"
                + f" • MOSFET_TEMPERATURES_WHILE_DISCHARGING: {PREF_CONFIG.MOSFET_TEMPERATURES_WHILE_DISCHARGING}"
                + f" • MAX_DISCHARGE_CURRENT_T_MOSFET: {PREF_CONFIG.MAX_DISCHARGE_CURRENT_T_MOSFET}"
            )
    ...
    def calc_max_charge_current_from_soc(self) -> float:
        ...
        try:
            ...
            if PREF_CONFIG.CHARGE_MODE == 2:
                return utils.calc_step_relationship(
                    self.soc_calc,
                    PREF_CONFIG.SOC_WHILE_CHARGING,
                    PREF_CONFIG.MAX_CHARGE_CURRENT_SOC,
                    True,
                )
            else:
                return utils.calc_linear_relationship(
            ...
            logger.error(
                ...
                + f" • SOC_WHILE_CHARGING: {PREF_CONFIG.SOC_WHILE_CHARGING}"
                + f" • MAX_CHARGE_CURRENT_SOC: {PREF_CONFIG.MAX_CHARGE_CURRENT_SOC}"
            )
    ...
    def calc_max_discharge_current_from_soc(self) -> float:
        ...
        try:
            ...
            if PREF_CONFIG.CHARGE_MODE == 2:
                return utils.calc_step_relationship(
                    self.soc_calc,
                    PREF_CONFIG.SOC_WHILE_DISCHARGING,
                    PREF_CONFIG.MAX_DISCHARGE_CURRENT_SOC,
                    True,
                )
            else:
                return utils.calc_linear_relationship(
            ...
            logger.error(
                f"soc_calc: {self.soc_calc}"
                + f" • SOC_WHILE_DISCHARGING: {PREF_CONFIG.SOC_WHILE_DISCHARGING}"
                + f" • MAX_DISCHARGE_CURRENT_SOC: {PREF_CONFIG.MAX_DISCHARGE_CURRENT_SOC}"
            )
    ...
    def get_time_to_soc(self, soc_target: float, percent_per_second: float, only_number: bool = False) -> str|None:
        """
        ...
        time_to_go_str = None
        if self.soc_calc != soc_target and percent_per_second != 0 and (soc_diff > 0 or PREF_CONFIG.TIME_TO_SOC_INC_FROM is True):
            seconds_to_go = int(soc_diff / percent_per_second)
            time_to_go_str = ""

            if only_number or PREF_CONFIG.TIME_TO_SOC_VALUE_TYPE & 1:
                time_to_go_str += str(seconds_to_go)
                if not only_number and PREF_CONFIG.TIME_TO_SOC_VALUE_TYPE & 2:
                    time_to_go_str += " ["
            if not only_number and PREF_CONFIG.TIME_TO_SOC_VALUE_TYPE & 2:
                time_to_go_str += self.get_seconds_to_string(seconds_to_go)

                if PREF_CONFIG.TIME_TO_SOC_VALUE_TYPE & 1:
                    time_to_go_str += "]"
    ...
    def get_midvoltage(self) -> Tuple[Union[float, None], Union[float, None]]:
        ...
        """
        PREF_CONFIG = get_pref_config()
        if not PREF_CONFIG.MIDPOINT_ENABLE or self.cell_count is None or self.cell_count == 0 or self.cell_count < 4 or len(self.cells) != self.cell_count:
            return None, None
    ...
    def get_filtered_temperature_map(self) -> Dict[int, float]:
        ...
        PREF_CONFIG = get_pref_config()
        return {sensor: temperature_map[sensor] for sensor in PREF_CONFIG.TEMPERATURE_SOURCE_BATTERY if temperature_map.get(sensor) is not None}
    ...
    def get_min_temperature_id(self) -> Union[str, None]:
        try:
            ...
            PREF_CONFIG = get_pref_config()
            return PREF_CONFIG.TEMPERATURE_NAMES.get(index)
        except TypeError:
            return None
    ...
    def validate_data(self) -> bool:
        ...
        if self.soc is not None and (self.soc < 0 or self.soc > 100):
            logger.warning(f"Data validation failed: SoC outside of thSOC_CALCULATIONresholds (from 0 to 100): {self.soc}")
            return False
    ...
    def get_current(self) -> Union[float, None]:
        ...
        if self.dbus_external_objects is not None and "Current" in self.dbus_external_objects and self.dbus_external_objects["Current"] is not None:
            ...
            if PREF_CONFIG.CURRENT_CORRECTION:
                # calculate current from real current
                current = round(
                    utils.calc_linear_relationship(
                        self.current,
                        PREF_CONFIG.CURRENT_REPORTED_BY_BMS,
                        PREF_CONFIG.CURRENT_MEASURED_BY_USER,
                    ),
                    3,
                )
                # set for debugging
    ...
    def get_soc(self) -> Union[float, None]:
        ...
        elif PREF_CONFIG.SOC_CALCULATION:
    ...
    def log_settings(self) -> None:
        ...
        logger.info(
            ...
            + (f" | SoC calc: {self.soc_calc:.0f}%" if PREF_CONFIG.SOC_CALCULATION else "")
        )
        logger.info(f"> Cell count: {self.cell_count} | Cells populated: {cell_counter}")
        logger.info(f'> CHARGE MODE: {"Linear" if PREF_CONFIG.CHARGE_MODE == 1 else "Step" if PREF_CONFIG.CHARGE_MODE == 2 else "Unknown"}')
        logger.info(
            f"> MIN CELL VOLTAGE: {PREF_CONFIG.MIN_CELL_VOLTAGE:.3f} V "
            + f"| MAX CELL VOLTAGE: {PREF_CONFIG.MAX_CELL_VOLTAGE:.3f} V"
            + f"| FLOAT CELL VOLTAGE: {PREF_CONFIG.FLOAT_CELL_VOLTAGE:.3f} V"
        )
        logger.info(
            f"> MAX BATTERY CHARGE CURRENT: {PREF_CONFIG.MAX_BATTERY_CHARGE_CURRENT} A | " + f"MAX BATTERY DISCHARGE CURRENT: {PREF_CONFIG.MAX_BATTERY_DISCHARGE_CURRENT} A"
        )
        if (
            (PREF_CONFIG.MAX_BATTERY_CHARGE_CURRENT != self.max_battery_charge_current or PREF_CONFIG.MAX_BATTERY_DISCHARGE_CURRENT != self.max_battery_discharge_current)
        ...
        logger.info(f"> CVCM:       {PREF_CONFIG.CVCM_ENABLE}")
        logger.info(f"> CCCM CV:    {str(PREF_CONFIG.CCCM_CV_ENABLE).ljust(5)} | DCCM CV:       {PREF_CONFIG.DCCM_CV_ENABLE}")
        logger.info(f"> CCCM T:     {str(PREF_CONFIG.CCCM_T_ENABLE).ljust(5)} | DCCM T:        {PREF_CONFIG.DCCM_T_ENABLE}")
        logger.info(f"> CCCM T MOS: {str(PREF_CONFIG.CCCM_T_MOSFET_ENABLE).ljust(5)} | DCCM T MOS:    {PREF_CONFIG.DCCM_T_MOSFET_ENABLE}")
        logger.info(f"> CCCM SOC:   {str(PREF_CONFIG.CCCM_SOC_ENABLE).ljust(5)} | DCCM SOC:      {PREF_CONFIG.DCCM_SOC_ENABLE}")
    ...
    def history_calculate_values(self) -> None:
        ...
        if "last_discharge" not in self.history.exclude_values_to_calculate:
            ...
            if self.history.last_discharge is None:
                ...
                if self.current_avg < 0 <= self.previous_current_avg and self.previous_current_avg is not None:
        ...
        if "charge_cycles" not in self.history.exclude_values_to_calculate:
            if self.history.total_ah_drawn is not None and self.history.total_ah_drawn > 0 and self.capacity is not None and self.capacity > 0:
                self.history.charge_cycles = round(self.history.total_ah_drawn / self.capacity)
        ...
        if "discharged_energy" not in self.history.exclude_values_to_calculate:
            if self.history.discharged_energy is None:
                ...
                self.history.discharged_energy = (
                    PREF_CONFIG.FLOAT_CELL_VOLTAGE * self.cell_count * self.capacity * self.history.charge_cycles / 1000
