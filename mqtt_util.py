...
def publish_sample_with_desc(client, device_topic, desc, sample):
    """
...
def publish_sample(client, device_topic, sample: BmsSample):
    ...
    if protection:
        publish_sample_with_desc(client, device_topic, alarm_desc, protection)
...
def publish_hass_discovery(client, device_topic, expire_after_seconds: int, sample: BmsSample, num_cells,
    ...
    def publish_hass_discovery_with_desc(desc, setting):
    ...
    protection = sample.protection
    if protection:
        publish_hass_discovery_with_desc(alarm_desc, protection)
